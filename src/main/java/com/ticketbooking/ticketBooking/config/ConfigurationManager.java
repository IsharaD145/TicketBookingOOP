package com.ticketbooking.ticketBooking.config;
...
public class ConfigurationManager {
    ...
    public static void configurationSave(TicketConfig ticketObject){
        ...
        try{
            File configFile = new File("src/main/java/com/ticketbooking/ticketBooking/config/Configuration.json");
    ...
    public static TicketConfig configurationLoad(){
        ...
        try{
            return objmapp.readValue(new File("src/main/java/com/ticketbooking/ticketBooking/config/Configuration.json"), TicketConfig.class);
        }catch (IOException e){
